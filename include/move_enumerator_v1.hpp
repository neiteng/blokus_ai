#ifndef MOVE_ENUMERATOR_V1_HPP
#define MOVE_ENUMERATOR_V1_HPP
...
class MoveEnumeratorV1
{
	...
	public:
		MoveEnumeratorV1(const Field& originalField, const ConstPlayerPtrList& playerPtrList, std::shared_ptr<const PieceAnalyst> pieceAnalystPtr_);
